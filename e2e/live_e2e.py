...
async def main():
    async with async_playwright() as p:
        ...
        if names:
            ...
            await pg.locator('button', has_text='Suspend').click(); await pg.wait_for_timeout(4000); rec('Instance', 'Suspend', 'Suspended' in await pg.locator('h1').inner_text()); await pg.locator('button', has_text='Resume').click(); await pg.wait_for_timeout(4000); rec('Instance', 'Resume', 'Active' in await pg.locator('h1').inner_text())
        ...
        await pg.click('a[href="/teams"]'); await pg.wait_for_timeout(6000); body = await pg.locator('body').inner_text(); rec('Teams', 'teams of the sample app with members', 'Managers' in body and 'Finance' in body and 'celladmin' in body)
